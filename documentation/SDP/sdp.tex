...
\title{Projektplan för mjukvaruutveckling}

\author{Cornelia Jeppsson, \texttt{dat11cje@student.lu.se}\\
...
Projektplan, Kravspecifikation samt Testspecifikation produceras. Fasen avslutas med en formell granskning (SSR, Software Specification Reviw) samt en formell baseline (SBL, Specification Baseline).

Tidsåtgång beräknas vara 3 veckor. 
...
\section{Hjälpmedel, Metoder och Stanarder}
