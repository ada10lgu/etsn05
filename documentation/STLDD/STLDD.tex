...
\fancyhead[R]{Datum: \today | Version: 1.0 | Dokumentnummer: PUSS144404}
...
@return boolean: True if the project name corresponds to the requirements.
\end{hangparas}

\vspace{5mm}
\begin{hangparas}{1.5em}{1}
private void listGroups(PrintWriter out)\\
Lists all the projects group.\\
@param out: PrintWriter object that is needed for print outs.\\
\end{hangparas}

\subsubsection{GroupHandling}

\vspace{5mm}
\begin{hangparas}{1.5em}{1}
private boolean addUserToGroup(int userID, int groupID, HttpServletRequest request)\\
Adds a user with a role to a project group.\\
@param userID: The id of the user who will be added to the project group.\\
@param groupID: The id of the project group to which the user will be added to.\\
...
\vspace{5mm}
\begin{hangparas}{1.5em}{1}
private boolean addAsRoleOk(int userID, int groupID, String role)\\
Checks if it's ok to add a user to a project group and if it's ok the user is added.\\
@param userID: The id of the user who will be added to the project group.\\
@param groupID: The id of the group to which the user will be added to.\\
@param role: The role the user will have in the project group.\\
@return boolean: true if the user was successfully added.\\
@throws SQLException
\end{hangparas}
...
Removes the user from the project group.\\
@param userID: The id of the user who will be removed from the project group.\\
...
Lists all users.\\
@param out: PrintWriter object needed for printing.\\
@param groupID: Don't print already added users from this project group.
\end{hangparas}
...
\begin{hangparas}{1.5em}{1}
private String selectRoleList()\\
Creates html code to produce a drop down menu with roles.
\end{hangparas}
...
\begin{figure}[h!]
\centering
\includegraphics[width=160mm]{UML_17okt.jpg}
