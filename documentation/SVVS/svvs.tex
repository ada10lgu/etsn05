...
\fancyhead[R]{Datum: \today |Version: 0.10 | Dokumentnummer: PUSS144403}
...
\begin{FT}
\item
Administratören kan ta bort alla användare förutom sig själv i systemet \req[6.2.14]

\item
\emph{Manuell miljö:} Administratören försöker ta bort sig själv från systemet \req[6.2.14]

\item
Administratör lyckas ta bort en tidrapportmall som inte används av en projektgrupp \req[6.2.21]
\end{FT}
...
\begin{FT}
\item
Projektmedlem lyckas skapa en egen osignerad tidrapport \req[6.3.1, 6.3.50]
\item
...
\begin{FT}
\item
\emph{Manuell miljö:} Projektledaren har tillgång till samtliga projektmedlemmars tidrapporter i sin projektgrupp \req[6.3.9]
\item
Projektledaren lyckas godkänna en ej tidigare godkänd tidrapport från en medlem i sin projektgrupp \req[6.3.10]
\item
Projektledaren lyckas ta tillbaka sitt godkännande från en tidigare godkänd tidrapport \req[6.3.11]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare \req[6.3.12]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll \req[6.3.13]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per aktivitet \req[6.3.14]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per vecka \req[6.3.15]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare och aktivitet \req[6.3.16]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare och vecka \req[6.3.17]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll och aktivitet \req[6.3.18]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll och vecka \req[6.3.19]
\item
Projektledaren lyckas generera statistik i form av tidrapporter per aktivitet och vecka \req[6.3.20]
\item
\emph{Manuell miljö:} Projektledaren kan se sammalagd arbetstid från valda tidrapporter \req[6.3.12-20, 6.3.21]
\item
\emph{Manuell miljö:} Projektledaren kan se sammalagd arbetstid från en vald aktivitet från valda tidrapporter \req[6.3.12-20, 6.3.22]
\item
\emph{Manuell miljö:} Projektledaren kan se sammalagd arbetstid från en vald subaktivitet från valda tidrapporter \req[6.3.13-20, 6.3.23]
\item
\emph{Manuell miljö:} Projektledaren kan se hur ofta en vald aktivitet har utförts i valda tidrapporter \req[6.3.13-20, 6.3.24]
\item
\emph{Manuell miljö:} Projektledaren kan se hur ofta en vald subaktivitet har utförts i valda tidrapporter \req[6.3.13-20, 6.3.25]
\item
\emph{Manuell miljö:} Projektledaren kan se vilken aktivitet som har tagit mest tid från tidrapportererna \req[6.3.13-20, 6.3.26]
\item
\emph{Manuell miljö:} Projektledaren kan se vilken aktivitet som är vanligast från tidrapportererna  \req[6.3.13-20, 6.3.27]
\item
\emph{Manuell miljö:} Projektledaren kan se vilken vecka som har mest rapporterad tid från tidrapportererna \req[6.3.13-20, 6.3.28]
\end{FT}
...
\begin{FT}
\item
Lagra 100 tidrapporter/användare \req[6.3.35]
\item
Försök att lagra mer än 100 tidrapporter/användare, efter uppnådd maxgräns skrivs
de över enligt FIFO-principen \req[6.3.35]
%Admin anger rätt mängd aktiviteter/subakt när scenario 6.2.4 genomförs i ST
\item
Administratör försöker ange 0 aktiviteter i en tidrapportmall \req[6.3.38]
\item
Administratör försöker ange 21 aktiviteter i en tidrapportmall \req[6.3.38]
\item
Administratör försöker ange 0 subaktiviteter i en tidrapportmall \req[6.3.39]
\item
Administratör försöker ange 21 subaktiviteter i en tidrapportmall \req[6.3.40]
\item
\emph{Manuell miljö:} Antalet aktiviteter anger antalet rader i tidrapporter \req[6.3.40]
\item
\emph{Manuell miljö:} Antalet subaktiviteter anger antalet kolumner i tidrapporter \req[6.3.41]
\item
\emph{Manuell miljö:} En tidrapport innehåller information om användarnamn \req[6.3.42, 6.3.51]
\item
\emph{Manuell miljö:} En tidrapport innehåller information om projektgruppsnamn \req[6.3.43, 6.3.51]
\item
\emph{Manuell miljö:} En tidrapport innehåller information om datum i form "dag månad år" \req[6.3.44, 6.3.51]
\item
\emph{Manuell miljö:} En tidrapport innehåller information om veckonummer \req[6.3.45, 6.2.51]
\item
\emph{Manuell miljö:} Det ska framgå tydligt att en tidrapport är signerad eller inte \req[6.3.46]
\item
Administratör försöker ändra tidrapportmallens utformning efter att den har
skapats \req[6.3.49]
\item
Generera grundmallen för tidrapporterna automatiskt av systemet \req[6.3.52]

\item
Försök skapa två aktiviteter med samma namn \req[6.3.53]

\item
Försök skapa två subaktiviteter med samma namn \req[6.3.54]

\end{FT}

%+++++++++++++++++++++++++++%
%SLUT på FT:Administration++%
%+++++++++++++++++++++++++++%
...
\item På administrationssidan är alla användare listade med både användarnamn och lösenord \req[6.4.21]

\item På administrationssidan kan man ta bort en vanlig användare \req[6.4.22]

\item På administrationssidan kan man ta bort en projektledare \req[6.4.22]

\item På administrationssidan kan man inte ta bort en administratör \req[6.4.22]


\item På administrationssidan kan man lägga till en ny användare \req[6.4.24]

\item Administratören skapar en användare och skriver in användarnamn, användarens lösenord genereras slumpmässigt \req[6.4.25]

\item Administratören försöker skapa en användare med ett upptaget användarnamn, ett felmeddelande visas \req[6.4.26]

\item Administratören försöker skapa en användare med ett ogiltigt användarnamn (giltigt användarnamn: 5-10 tecken, ascii 48-57, 65-90 och 97-122) \req[6.4.27]

\item Administratören skapar en användare med ett giltigt användarnamn (giltigt användarnamn: 5-10 tecken, ascii 48-57, 65-90 och 97-122) \req[6.4.27]
...
\begin{FT}
\item Administratören försöker skapa en projektgrupp med ett ogiltigt projektgruppsnamn (giltigt projektgruppsnamn: 5-10 tecken, ascii 48-57 och 97-122) \req[6.4.29]

\item Administratören försöker skapa en projektgrupp med ett giltigt projektgruppsnamn (giltigt projektgruppsnamn: 5-10 tecken, ascii 48-57 och 97-122) \req[6.4.29]

\item Administratören försöker skapa en projektgrupp med ett upptaget projektgruppsnamn \req[6.4.30]

\item Administratören skapar 5 stycken projektgrupper \req[6.4.31]

\item Administratören försöker skapa 6 stycken projektgrupper \req[6.4.31]

\item Administratören lägger till samma användare i flera projektgrupper \req[6.4.32]

\item Administratören försöker skapa en projektgrupp utan användare \req[6.4.33]

\item Administratören försöker att, från en projektgrupp som har en användare, ta bort en användare \req[6.4.33]

\item Administratören skapar en projektgrupp med en användare \req[6.4.33]

\item Administratören lägger till användare i en projektgrupp så att projektgruppen har 20 användare \req[6.4.33]

\item Administratören försöker lägga till användare i en projektgrupp så att projektgruppen har 21 användare \req[6.4.33]

\item Projektledaren tilldelar tre olika roller till projektmedlemmar i sitt projekt \req[6.4.34]

\item Projektledaren försöker tilldela fyra olika roller till projektmedlemmar i sitt projekt \req[6.4.34]

\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t1 \req[6.4.35]

\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t2 \req[6.4.35]

\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t3 \req[6.4.35]

\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t1 \req[6.4.35]

\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t2 \req[6.4.35]

\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t3 \req[6.4.35]

\item Administratören har användarnamnet ``admin'' och lösenordet ``adminpw'' \req[6.4.36]
\end{FT}
...
\item
Flödesschemat i figur 3 i SRS (ref 1) stödjs av systemet \req[6.1.10]
...
\begin{ST}
\item
Administratören försöker lägga till sig själv i en projektgrupp \req[6.1.11]
...
\begin{ST}
\item
Genomför scenario 6.2.1 (ref 1: Skapa projektgrupp) \req[6.2.16, 6.3.31]
\item
Genomför scenario 6.2.2 (ref 1: Lägga till/ändra roll på projektmedlem i projektgrupp) \req[6.2.17]
\item
Genomför scenario 6.2.3 (ref 1: Ta bort projektmedlemmar eller projektgrupp) \req[6.2.18]
\item
Genomför scenario 6.2.4 (ref 1: Skapa tidrapportmall) \req[6.2.19, 6.3.32, 6.3.34, 6.3.37, 6.3.47]
\item
Genomför scenario 6.2.5 (ref 1: Ta bort tidrapportmall) \req[6.2.20, 6.3.48]
\end{ST}
...
\begin{ST}
\item
Genomför scenario 6.3.1 (Dokumentera arbetstimmar i systemet) \req[6.3.6, 6.3.5, 6.3.33, 6.3.36]
\item
Genomför scenario 6.3.2 (Ta bort/redigera arbetstimmar i systemet) \req[6.3.7]
\item
Systemet stödjer stegen i figur 5 \req[6.3.8]
\end{ST}
...
\begin{ST}
\item
Systemet stödjer stegen i figur 6 \req[6.3.29]
\end{ST}
%++++++++++++++++++++++++++%
...
\begin{ST}
\item Genomför scenario 6.4.1 (Generera rapporter från systemet) \req[6.4.6]

\item Genomför scenario 6.4.2 (Godkänna en tidrapport) \req[6.4.7]

\item Genomför scenario 6.4.3 (Ta tillbaka godkännande av en tidrapport) \req[6.4.8]

\item Genomför scenario 6.4.4 (Hitta en rapport genom att sortera dem) \req[6.4.9]
\end{ST}

\subsubsection{Administratör}

\begin{ST}
\item Genomför scenario 6.4.1 som administratör istället för projektledare (Generera rapporter från systemet) \req[6.4.15]

\item Genomför scenario 6.4.2 som administratör istället för projektledare (Godkänna en tidrapport) \req[6.4.16]

\item Genomför scenario 6.4.3 som administratör istället för projektledare (Ta tillbaka godkännande av en tidrapport) \req[6.4.17]

\item Genomför scenario 6.4.4 som administratör istället för projektledare (Hitta en rapport genom att sortera dem) \req[6.4.18]

\item Genomför scenario 6.4.5 \req[6.4.19]

\item Genomför sekvenserna \req[6.4.20]
\end{ST}
