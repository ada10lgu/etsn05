...
\fancyhead[R]{Datum: \today |Version: 0.11 | Dokumentnummer: PUSS144403}
...
%ändrad 23/9**
\item
Projektmedlem lyckas skapa en egen osignerad tidrapport \req[6.3.1, 6.3.43]
\item
...
%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare \req[6.3.13]

%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll \req[6.3.14]
...
%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare och vecka \req[6.3.18]
...
%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll och vecka \req[6.3.20]
...
%ändrad 23/9**
\item
Lagra 100 tidrapporter/användare \req[6.3.28]

%ändrad 23/9**
\item
Försök att lagra mer än 100 tidrapporter/användare, efter uppnådd maxgräns skrivs
de över enligt FIFO-principen \req[6.3.28]
...
%ändrad 23/9**
\item
Administratör försöker ange 21 subaktiviteter i en tidrapportmall \req[6.3.33]
...
%ändrad 23/9**
\item
\emph{Manuell miljö:} En tidrapport innehåller information om användarnamn \req[6.3.35, 6.3.46]

%ändrad 23/9**
\item
\emph{Manuell miljö:} En tidrapport innehåller information om projektgruppsnamn \req[6.3.36, 6.3.44]

%ändrad 23/9**
\item
\emph{Manuell miljö:} En tidrapport innehåller information om datum i form "dag månad år" \req[6.3.37, 6.3.44]

%ändrad 23/9**
\item
\emph{Manuell miljö:} En tidrapport innehåller information om veckonummer \req[6.3.38, 6.2.44]

%ändrad 23/9**
\item
\emph{Manuell miljö:} Det ska framgå tydligt att en tidrapport är signerad eller inte \req[6.3.39]
...
%ändrad 23/9
\item Administratören försöker skapa en projektgrupp med ett ogiltigt projektgruppsnamn (giltigt projektgruppsnamn: 5-10 tecken, ascii 48-57 och 97-122) \req[6.4.37]

%ändrad 23/9
\item Administratören försöker skapa en projektgrupp med ett giltigt projektgruppsnamn (giltigt projektgruppsnamn: 5-10 tecken, ascii 48-57 och 97-122) \req[6.4.37]

%ändrad 23/9
\item Administratören försöker skapa en projektgrupp med ett upptaget projektgruppsnamn \req[6.4.38]

%ändrad 23/9
\item Administratören skapar 5 stycken projektgrupper \req[6.4.39]

%ändrad 23/9
\item Administratören försöker skapa 6 stycken projektgrupper \req[6.4.39]

%ändrad 23/9
\item Administratören lägger till samma användare i flera projektgrupper \req[6.4.40]

%ändrad 23/9
\item Administratören försöker skapa en projektgrupp utan användare \req[6.4.41]

%ändrad 23/9
\item Administratören försöker att, från en projektgrupp som har en användare, ta bort en användare \req[6.4.41]

%ändrad 23/9
\item Administratören skapar en projektgrupp med en användare \req[6.4.41]

%ändrad 23/9
\item Administratören lägger till användare i en projektgrupp så att projektgruppen har 20 användare \req[6.4.41]

%ändrad 23/9
\item Administratören försöker lägga till användare i en projektgrupp så att projektgruppen har 21 användare \req[6.4.41]

%ändrad 23/9
\item Projektledaren tilldelar tre olika roller till projektmedlemmar i sitt projekt \req[6.4.42]

%ändrad 23/9
\item Projektledaren försöker tilldela fyra olika roller till projektmedlemmar i sitt projekt \req[6.4.42]

%ändrad 23/9
\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t1 \req[6.4.43]

%ändrad 23/9
\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t2 \req[6.4.43]

%ändrad 23/9
\item Projektledaren tilldelar 6 projektmedlemmar i sitt projekt rollen t3 \req[6.4.43]

%ändrad 23/9
\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t1 \req[6.4.43]

%ändrad 23/9
\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t2 \req[6.4.43]

%ändrad 23/9
\item Projektledaren försöker tilldela 7 projektmedlemmar i sitt projekt rollen t3 \req[6.4.43]

%ändrad 23/9
\item Administratören har användarnamnet ``admin'' och lösenordet ``adminpw'' \req[6.4.44]
\end{FT}
...
%ändrad 23/9**
\item
Genomför scenario 6.4.5 (ref 1: Skapa projektgrupp) \req[6.4.31, 6.3.24]

%ändrad 23/9
\item
Genomför scenario 6.4.6 (ref 1: Lägga till/ändra roll på projektmedlem i projektgrupp) \req[6.4.32]

%ändrad 23/9
\item
Genomför scenario 6.4.7 (ref 1: Ta bort projektmedlemmar eller projektgrupp) \req[6.4.33]

%ändrad 23/9
%ändrad 23/9** (klar)
\item
Genomför scenario 6.4.8 (ref 1: Skapa tidrapportmall) \req[6.4.34, 6.3.24, 6.3.27, 6.3.30, 6.3.40]
...
%ändrad 23/9**
\item
Genomför scenario 6.3.1 (Dokumentera arbetstimmar i systemet) \req[6.3.7, 6.3.5, 6.3.26, 6.3.29]
...
%ändrad 23/9**
\item
Systemet stödjer stegen i figur 5 \req[6.3.9]
\end{ST}
...
%ändrad 23/9**
\item
Systemet stödjer stegen i figur 6 \req[6.3.22]
\end{ST}
%++++++++++++++++++++++++++%
