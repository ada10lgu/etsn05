...
\fancyhead[R]{Datum: \today |Version: 1.3 | Dokumentnummer: PUSS144403}
...
v0.10 & 22 september 2014 & TG & La till test för två nya krav \\
v0.11 & 23 september 2014 & TG & Anpassat efter SRS v0.19 \\
v0.12 & 26 september 2014 & TG & Anpassat efter SRS v0.20 och informell granskning, omformuleringar, rättning av stavfel. Ang. informell granskning, "valda tidrapporter" är taget direkt från SRS, datumet för PR är inte utskrivet i SDP\\
v0.13 & 30 september 2014 & TG & Tagit bort test som utgått\\
v0.14 & 5 oktober 2014 & TG & Anpassad efter SRS v0.21\\
v1.0 & 15 oktober 2014 & TG & Baseline\\
v1.1 & 24 oktober 2014 & TG & Fixad efter SRS 1.1. FT 3.2.6, 3.2.8, 3.2.10, 3.2.12 har utgått. FT 3.2.4, 3.2.5, 3.2.7, 3.2.9, 3.2.11 är uppdaterade\\
v1.2 & 26 oktober 2014 & TG & uppdaterad efter SRS v1.2. ST 2.1.1 har utgått\\
v1.3 & 4 november 2014 & TG & uppdaterad efter SRS v1.4. FT 2.1.2 har utgått. FT 3.2.9 och FT 3.2.11 har uppdaterats till "konsekutiva veckor".\\
\end{tabular}
\section{Inledning}       
...
%ändrad 23/9**
\item
Projektledare genererar en statistik i form av en tidrapport med den totala tid som en användare har lagt
%Projektledaren lyckas generera statistik i form av tidrapporter per användare för samtliga veckor 
\req[6.3.13]

%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll för samtliga veckor. Alltså generera en tidrapport med summan av alla tid som varje medlem av en given roll har lagt ner på varje moment. \req[6.3.14]

%ändrad 23/9**
\item
%Projektledaren lyckas generera statistik i form av tidrapporter per aktivitet 
Utgått
\req[6.3.15]

%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per vecka. Alltså generera en tidrapport med den total tid som har lagts på varje moment under en given vecka \req[6.3.16]

%ändrad 23/9**
\item
%Projektledaren lyckas generera statistik i form av tidrapporter per användare och aktivitet 
Utgått
\req[6.3.17]

%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per användare för utvalda konsekutiva veckor. Alltså summera all tid för varje moment för en given användare och givna veckor \req[6.3.18]

%ändrad 23/9**
\item
%Projektledaren lyckas generera statistik i form av tidrapporter per roll och aktivitet 
Utgått
\req[6.3.19]

%ändrad 23/9**
\item
Projektledaren lyckas generera statistik i form av tidrapporter per roll för utvalda konsekutiva veckor. Alltså summera all tid för varje moment för en given roll och givna veckor. \req[6.3.20]

%ändrad 23/9**
\item
%Projektledaren lyckas generera statistik i form av tidrapporter per aktivitet och vecka 
Utgått
\req[6.3.21]
...
\item
En projektmedlem försöker ge ogiltigt veckonummer (giltigt veckonummer: 1-2 tecken, ascii (decimal) värden 48-57). \req[6.3.26, 6.1.4]

\item
En projektmedlem ger giltigt veckonummer (giltigt veckonummer: 1-2 tecken, ascii (decimal) värden 48-57). \req[6.3.26]

%ändrad 23/9**
\item
\emph{Manuell miljö:} Det ska framgå tydligt att en tidrapport är signerad eller inte \req[6.3.33]

\item Aktivitetsnamn är unika. \req[6.3.37]

\item Subaktivitetsnamn är unika. \req[6.3.38]

\item Tidrapporten har rätt utseende. \req[6.3.39, 6.3.29, 6.3.30, 6.3.31, 6.3.32]
%%ändrad 23/9**
%\item
