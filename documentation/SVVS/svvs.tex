...
\fancyhead[R]{Datum: \today |Version: 0.12 | Dokumentnummer: PUSS144403}
...
\item
\emph{Manuell miljö:} Projektledare har tillgång till projektadministrationsfunktionaliteter \req[6.1.9]
\end{FT}
...
\req[6.2.24]
\item
Användaren kan välja mellan alla befintliga projektgrupper i systemet på inloggningssidan \req[6.2.25]
\item
Användaren skall specificera vilken projektgrupp den vill logga in på \req[6.2.26]
\item
Användare lyckas logga in på de projektgrupp(er) som denne är medlem i \req[6.2.27]
\item
Användare försöker logga in på en projektgrupp som denne inte är medlem i \req[6.2.27]
\item
Administratören lyckas logga in på samtliga projektgrupper \req[6.2.27]
\end{FT}
...
%ändrad 23/9**
\item
\emph{Manuell miljö:} En tidrapport innehåller information om datum i form av "dag månad år" \req[6.3.37, 6.3.44]
...
%ändrad 23/9**
\item
Genomför scenario 6.4.5 (Ref 1: Skapa projektgrupp) \req[6.4.19, 6.3.24]
...
%ändrad 23/9**
\item
Genomför scenario 6.3.1 (Ref 1: Dokumentera arbetstimmar i systemet) \req[6.3.7, 6.3.5, 6.3.26, 6.3.29]

%ändrad 23/9**
\item
Genomför scenario 6.3.2 (Ref 1: Ta bort/redigera arbetstimmar i systemet) \req[6.3.8]
...
\begin{ST}
\item Genomför scenario 6.4.1 som administratör istället för projektledare (Ref 1: Generera rapporter från systemet) \req[6.4.15]

\item Genomför scenario 6.4.2 som administratör istället för projektledare (Ref 1: Godkänna en tidrapport) \req[6.4.16]

\item Genomför scenario 6.4.3 som administratör istället för projektledare (Ref 1: a tillbaka godkännande av en tidrapport) \req[6.4.17]

\item Genomför scenario 6.4.4 som administratör istället för projektledare (Ref 1: itta en rapport genom att sortera dem) \req[6.4.18]
