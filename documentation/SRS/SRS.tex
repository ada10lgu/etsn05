...
\subsubsection*{Användare}
			\requirement{7}{Krav 6.1.3 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{8}{Krav 6.1.4 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{9}{Krav 6.1.5 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}


		\subsubsection*{Administratör}
			\requirement{10}{I administrationsvyn skall det vara möjligt att ta bort vilken användare som helst förutom administratören.}
			\requirement{11}{Om en administratör försöker lägga till en ny användare med ett användarnamn som strider mot krav 6.3.1-2 skall ett felmeddelande visas och användaren skall inte läggas till.}
			\requirement{12}{Scenario 6.4.1 skall stödjas av systemet.}
			\requirement{13}{Scenario 6.4.2 skall stödjas av systemet.}
			\requirement{14}{Scenario 6.4.3 skall stödjas av systemet.}
			\requirement{15}{Scenario 6.4.4 skall stödjas av systemet.}
			\requirement{16}{Scenario 6.4.5 skall stödjas av systemet.}
			\requirement{17}{Administratören skall kunna ta bort en tidrapportmall om den inte används av en projektgrupp (se krav 6.3.18).}
			
		\subsubsection*{Data}
			\requirement{19}{Krav 6.1.1 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{20}{Krav 6.1.7 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
