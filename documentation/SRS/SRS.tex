...
Syftet med laborationen var att studera optokomponenter i form av dioder. Laborationen bestod av tre olika moment där dioders absorption och emission mättes, diod som solcell studerades samt en diod tillverkades.


\section{Utförande}             % Detta blir en underrubrik
\subsection{Lysdiod - emission och absorption}
Med hjälp av en monokromator, i vilken ljuset delades upp med ett glasprisma, belystes en diod. Dioden reagerade på en specifik våglängd som gav upphov till en ström. Detta kunde registreras på datorn.

Genom att istället låta dioden belysa en fotodetektor kunde emissionen mätas. Även detta registrerades på datorn.

\subsection{Solcellen}
En diod kopplades upp enligt kretsschemat i laborationshandledningen. Genom att variera belastningsresistansen erhölls olika ström- respektive spänningsvärden vid konstant belysning(på dioden/solcellen). 
Dessa värden användes sedan för att plotta ett I-U - diagram. Även den maximala effekten beräknades.
