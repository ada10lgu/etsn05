...
Lade till krav, kapitel \ref{krav-funk-data}\\
0.17 & 16 september 2014 & SG & Ändrat krav \ref{krav-funk-data}.18, \ref{krav-funk-data}.19, scenario \ref{krav-funk-admin}.4 och scenario \ref{krav-funk-admin}.3. Lagt till krav \ref{krav-funk-admin}.21, \ref{krav-funk-admin}.22 och scenario \ref{krav-funk-admin}.5.
\\
...
\requirement{8}{Maximalt 20 mallar kan lagras samtidigt, efter uppnådd maxgräns kan ej fler lagras.}
\requirement{9}{En tidrapportmall ska bestå av 1-20 rader samt 1-5 kolumner som det går att mata in tidinformation i.}
...
\requirement{18}{En tidrapportmall kan endast tas bort om den inte används av någon projektgrupp.}
\requirement{19}{Det skall inte vara möjligt att ändra tidrapportmallens utformning efter att den har skapats.}
\requirement{20}{Det får maximalt existera 5 stycken grupper samtidigt.}
...
\requirement{17}{Scenario \ref{krav-funk-admin}.1 skall stödjas av systemet.}
\requirement{18}{Scenario \ref{krav-funk-admin}.2 skall stödjas av systemet.}
\requirement{19}{Scenario \ref{krav-funk-admin}.3 skall stödjas av systemet.}
\requirement{20}{Scenario \ref{krav-funk-admin}.4 skall stödjas av systemet.}
\requirement{21}{Scenario \ref{krav-funk-admin}.5 skall stödjas av systemet.}
\requirement{22}{Administratören skall kunna ta bort en tidrapportmall om den inte används av en projektgrupp (se krav \ref{krav-funk-data}.18).}
...
\begin{tabular}{ | p{2cm} p{11cm} | }
    ...
    \multicolumn{2}{|p{13cm}|}{3a. Det går inte att skapa fler mallar på grund av uppnådd maxgräns (se krav \ref{krav-funk-data}.18). Användaren informeras om detta.}\\
