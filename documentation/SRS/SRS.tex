...
\requirement{x}{Projektledarna har tillgång till projektadministrationsfunktionaliter. Det listas som ``projektadministration'' och finns tillgängligt för dem i menyn.}
	...
	\subsection{Autentisering}
		...
		\subsubsection*{Övergripande}
			...
			\requirement{5}{Scenario 6.2.1 skall stödjas av systemet.}
			\requirement{6}{Scenario 6.2.2 skall stödjas av systemet.}
			\requirement{7}{Krav 6.1.2 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{8}{Krav 6.2.1 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{9}{Krav 6.2.2 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{10}{Krav 6.2.3 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{11}{Krav 6.2.4 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
\subsubsection*{Användare}
			\requirement{12}{Krav 6.1.3 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{13}{Krav 6.1.4 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{14}{Krav 6.1.5 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{15}{Krav 6.1.8 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{16}{Krav 6.1.9 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}


		\subsubsection*{Administratör}
			\requirement{17}{I administrationsvyn skall det vara möjligt att ta bort vilken användare som helst förutom administratören.}
			\requirement{18}{Om en administratör försöker lägga till en ny användare med ett användarnamn som strider mot krav 6.3.1-2 skall ett felmeddelande visas och användaren skall inte läggas till.}
			\requirement{19}{Scenario 6.4.1 skall stödjas av systemet.}
			\requirement{20}{Scenario 6.4.2 skall stödjas av systemet.}
			\requirement{21}{Scenario 6.4.3 skall stödjas av systemet.}
			\requirement{22}{Scenario 6.4.4 skall stödjas av systemet.}
			\requirement{23}{Scenario 6.4.5 skall stödjas av systemet.}
			\requirement{24}{Administratören skall kunna ta bort en tidrapportmall om den inte används av en projektgrupp (se krav 6.3.18).}
			
		\subsubsection*{Data}
			\requirement{25}{Krav 6.1.1 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
			\requirement{26}{Krav 6.1.7 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}

		\subsubsection*{Ej inloggad}
			\requirement{27}{Krav 6.1.6 från Grundsystemet (Referensdokument 1) skall stödjas av systemet.}
	...
	\subsection{Administration}
		...
		\subsubsection*{Administratör}
			...
			\requirement{23}{Krav 6.3.7 från Grundsystemet (Referensdokument 1) har utgått och ersatt av krav……...}
