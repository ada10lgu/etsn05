...
\requirement{5}{Projektledarna har tillgång till projektadministrationsfunktionaliter. Det listas som ''projektadministartion'' och finns tillgänligt för dessa i menyn.}
...
\begin{tabular}{ | p{2cm} p{11cm} | }
	...
	\multicolumn{2}{|p{13cm}|}{3. Informationen som skall tas bort markeras och därefter trycks ''OK''. Bekräftelserutan specifierad i krav \ref{krav-funk-gen}.10 visas.} \\	
