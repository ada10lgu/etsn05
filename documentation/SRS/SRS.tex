...
\subsubsection*{Användare}
		...
		\subsubsection*{Administratör}
			\requirement{14}{I administrationsvyn skall det vara möjligt att ta bort vilken användare som helst förutom administratören.}
			\requirement{15}{Om en administratör försöker lägga till en ny användare med ett användarnamn som strider mot krav 6.3.1-2 skall ett felmeddelande visas och användaren skall inte läggas till.}
...
% ----------------------- /END			
			...
			\requirement{21}{Administratören skall kunna ta bort en tidrapportmall om den inte används av en projektgrupp (se krav 6.3.18).}
...
% ----------------------- /END			
			...
			\requirement{6}{Scenario 6.3.1 skall stödjas av systemet.}
			\requirement{7}{Scenario 6.3.2 skall stödjas av systemet.}
			\begin{figure}[h!]
				\centering
			...
			\end{figure}
		\requirement{8}{Systemet skall stödja de steg som tas i figur \ref{image_time_promed}.}
		...
		\subsubsection*{Projektledare}
			...
			\requirement{21}{Projektledaren ska kunna se sammanlagd arbetstid från valda tidrapporter.}
			\requirement{22}{Projektledaren ska kunna se sammanlagd arbetstid för en vald aktivitet från valda tidrapporter.}
			\requirement{23}{Projektledaren ska kunna se sammanlagd arbetstid för en vald subaktivitet från valda tidrapporter.}
			\requirement{24}{Projektledaren ska kunna se hur ofta en vald aktivitet har utförts i valda tidrapporter.}
			\requirement{25}{Projektledaren ska kunna se hur ofta en vald subaktivitet har utförts i valda tidrapporter.}
			\requirement{26}{Projektledaren ska kunna se vilken aktivitet som har tagit mest tid.}
			\requirement{27}{Projektledaren ska kunna se vilken aktivitet som är vanligast.}
			\requirement{28}{Projektledaren ska kunna se vilken vecka som har mest rapporterad tid.}
			\begin{figure}[h!]
				\centering
			...
			\end{figure}
		\requirement{29}{Systemet skall stödja de steg som tas i figur \ref{image_time_proboss}.}

		\subsubsection*{Data}
			\requirement{30}{Tidrapportering sker i antal minuter.}
			\requirement{31}{Namnet på tidrapportmallen ska bestå av 5 tecken, ascii (decimal) värden 48-57 och 97-122 är tillåtna.}
			\requirement{32}{Namnet på aktivitet och subaktivitet ska bestå av 3-5 tecken respektive 1 tecken, ascii (decimal) värden 48-57 och 97-122 är tillåtna.}

			\requirement{33}{Tidinformationen får innehålla 1-5 tecken per aktivitetsruta, ascii (decimal) värden 48-57.}
			\requirement{34}{Tidrapportmallarnas namn måste vara unika. }
 	 	 		
			\requirement{35}{Det skall gå att lagra 100 tidrapporter/användare. Efter uppnådd maxgräns skrivs de över enligt FIFO-principen.}
			\requirement{36}{Veckonumret får innehålla 1-2 tecken, ascii (decimal) värden 48-57.}
			\requirement{37}{En administratör skall kunna skapa tidrapportsmallar.}
			\requirement{38}{Man skall kunna ange 1-20 stycken aktiviteter i en tidrapportsmall.}
			\requirement{39}{Man skall kunna ange 1-20 stycken subaktiviteter i en tidrapportsmall.}
			\requirement{40}{Antalet aktiviteter anger antalet rader som finns i tidrapportstabellen.}
			\requirement{41}{Antalet subaktiviteter anger antalet kolumner som finns i tidrapportstabellen.}
			\requirement{42}{En tidrapport skall innehålla information om användarnamn.}
			\requirement{43}{En tidrapport skall innehålla information om projektgruppsnamn.}
			\requirement{44}{En tidrapport skall innehålla information om datum. Datum skrivs på formatet ``dag månad år'', där dag representeras av två siffror (ascii (decimal) värden 48-57), månaden som namnet på månaden (ascii (decimal) värden 97-122) , och år med fyra siffor (ascii (decimal) värden 48-57).}
			\requirement{45}{En tidrapport skall innehålla information om veckonummer.}
			\requirement{46}{Det skall tydligt framgå om en tidrapport är signerad eller inte.}
			\requirement{47}{Maximalt 20 mallar kan lagras samtidigt.}
			\requirement{48}{En tidrapportmall kan endast tas bort om den inte används av någon projektgrupp.}
			\requirement{49}{Det skall inte vara möjligt att ändra tidrapportmallens utformning efter att den har skapats.}
			\requirement{50}{Nygenererade tidrapporter är alltid osignerade.}
			\requirement{51}{Tidrapportens grundmall skall innehålla information om användarnamn, projektgruppsnamn, datum och veckonummer. Det skall även tydligt framgå om den är signerad eller ej.}
			\requirement{52}{Grundmallen för tidrapporterna genereras automatiskt av systemet.}
...
% ----------------------- /END			
		...
		\subsubsection*{Data}
			...
			\requirement{34}{I varje projektgrupp kan det finnas upp till tre Projektroller, t1, t2 och t3.}
