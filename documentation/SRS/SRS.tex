...
\fancyhead[R]{Datum: \today | Version: 0.20 | Dokumentnummer: PUSS144401}
...
\subsubsection*{Användare}
		...
		\subsubsection*{Ej inloggad}
			...
			\requirement{25}{På inloggningssidan skall användaren ha möjlighet att välja bland alla befintliga projektgrupper i systemet.}
			\requirement{26}{För att kunna utföra autentiseringen mot systemet skall användaren specificera vilken projektgrupp den vill logga in på.}
			\requirement{27}{Användaren skall endast kunna logga in på de projektgrupper denne är medlem i. Detta krav gäller ej för administratören.}
...
% ----------------------- /END			
		...
		\subsubsection*{Data}
			...
			\requirement{32}{Man skall kunna ange 1-4 stycken subaktiviteter i en tidrapportsmall.}
...
\begin{tabular}{ | p{2cm} p{11cm} | }
	...
	\multicolumn{2}{|p{13cm}|}{2. Användaren väljer därefter att skapa en tidrapportmall (se scenario 6.4.8).}\\
	...
	\hline
    \multicolumn{2}{|p{13cm}|}{\textbf{Varianter}: }\\
    \multicolumn{2}{|p{13cm}|}{2a. Användaren väljer en befintlig tidrapportmall, som är sparad sedan tidigare.}\\
...
\begin{tabular}{ | p{2cm} p{11cm} | }
    ...
    \multicolumn{2}{|p{13cm}|}{3a. Om namnet på mallen redan existerar informeras användaren om detta och ombedes att skriva ett annat namn. Användaren skickas tillbaka till steg 3.}\\
...
% ----------------------- /END			
		...
		\subsubsection*{Data}
			...
			\requirement{40}{En användare kan vara projektmedlem i mer än en projektgrupp åt gången.}
