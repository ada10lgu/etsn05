...
% ----------------------- /END			
		...
		\subsubsection*{Data}
			...
			\begin{figure}[H]
				...
				\caption{Grundmallen för tidrapporter. Mörkgrå fält är kodade i systemet, ljusgrå fält genereras av systemet, svarta fält ska vara tomma och vita fält fylls av användaren.}
				\label{image_gen_grundmall}
			\end{figure}
			\requirement{39}{Tidrapportens grundmall skall innehålla aktiviteter och subaktiviteter enligt formatet i figur 8.}
