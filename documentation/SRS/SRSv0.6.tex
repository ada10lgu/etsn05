...
\requirement{11}{Om en administratör försöker lägga till en ny användare med ett användarnamn som strider mot KRAV X (SE BASEKRAV) ska ett felmeddelande visas och användaren ska inte läggas till.}

\requirement{12}{Endast administratören ska kunna skapa projektgrupper i systemet.}
\requirement{13}{Då en ny användare skapas ska administratören ange den information som är specifierat av Krav \ref{krav-funk-data}.3.}
\requirement{12}{Då en ny projektgrupp skapas ska admin ange den information som är specifierat av Krav \ref{krav-funk-data}.4.}
\requirement{13}{Om admin försöker skapa en projektgrupp med ett namn som redan existerar ska projektgruppen inte skapas och ett felmeddelande ska visas.}
\requirement{14}{Endast administratören (admin) ska kunna ta bort projektgrupper i systemet.}
\requirement{15}{När en projektgrupp tas bort ska admin kunna välja projektgrupp ur en lista på alla projektgrupper i systemet.}

\requirement{6}{Endast administratören (admin) ska kunna inaktivera alla användarkonton förutom sitt eget.}

\requirement{7}{Endast administratören (admin) ska kunna aktivera alla tidigare inaktiverade konton.}

\requirement{8}{När en användare inaktiveras ska admin kunna välja mellan alla aktiva användare från en lista genererat av systemet.}

\requirement{9}{När en användare läggs till, inaktiveras eller aktiveras ska en bekräftelseruta visas där admin kan välja att bekräfta och slutföra ändringen eller välja avbryt så att ingen ändring görs.}
