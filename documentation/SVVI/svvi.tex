...
>>>>>>> 51269217b195e392286b497558a823bb70188392
...
\emph{Starttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. A är medlem i projektgrupp G.

\emph{Sluttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. A är medlem i projektgrupp G. En osignerad tidsrapport i G för A finns för vecka 1 med 20 minuter under ``möte''.

\begin{enumerate}
\item A trycker på ``Skapa en ny tidrapport''.
\item Skriv in 1 under ``vecka''.
\item Skriv in 20 under ``möte''.
...
\emph{Starttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. A är medlem i projektgrupp G. En osignerad tidsrapport T i G för A finns för vecka 1 med 20 minuter under ``möte''.

\emph{Sluttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering, uppdaterad tidrapport visas. En osignerad tidsrapport T i G för A finns för vecka 1 med 40 minuter under ``möte'' och 30 minuter udner ``SRS''.

\begin{enumerate}
\item A trycker på ``Uppdatera tidrapport''.
\item A väljer T.
\item A skriver in 40 under ``möte'', 30 under ``SRS''.
...
\emph{Sluttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. Tidrapport raderad. A är medlem i projektgrupp G.
...
\emph{Starttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. A är medlem i projektgrupp G. En osignerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''. Det finns en annan projektmedlem B. B är medlem i projektgrupp G. En osignerad tidsrapport T2 i G för B finns för vecka 1 med 30 minuter under ``möte''.
...
\item Se till att endast As tidrapport visas.
\end{enumerate}
...
\emph{Starttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. A är medlem i projektgrupp G. En signerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''.

\emph{Sluttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. Tidrapport ej raderad. A är medlem i projektgrupp G.
...
\emph{Starttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering. En signerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''.

\emph{Sluttillstånd:} Projektmedlem A inloggad, inne på funktionalitetssidan för tidrapportering, tidrapport ej uppdaterad. En signerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''.
...
\emph{Starttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. En osignerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''. Det finns en annan projektmedlem M. M är medlem i projektgrupp G. En signerad tidsrapport T2 i G för M finns för vecka 1 med 30 minuter under ``möte''.

\emph{Sluttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. En osignerad tidsrapport T1 i G för A finns för vecka 1 med 20 minuter under ``möte''. Det finns en annan projektmedlem M. M är medlem i projektgrupp G. En signerad tidsrapport T2 i G för M finns för vecka 1 med 30 minuter under ``möte''.

\begin{enumerate}
\item A trycker på ``Visa tidrapporter''.
\item Se till att A kan se alla tidsrapporter i G.
...
\emph{Starttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. M är projektmedlem i projektgrupp G. En osignerad tidsrapport T1 i G för M finns för vecka 1 med 20 minuter under ``möte''.

\emph{Sluttillstånd:} Projektledare inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. M är projektmedlem i projektgrupp G. En signerad tidsrapport T1 i G för M finns för vecka 1 med 20 minuter under ``möte''.
...
\emph{Starttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. M är projektmedlem i projektgrupp G. En signerad tidsrapport T1 i G för M finns för vecka 1 med 20 minuter under ``möte''.

\emph{Sluttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. M är projektmedlem i projektgrupp G. En osignerad tidsrapport T1 i G för M finns för vecka 1 med 20 minuter under ``möte''.
...
\emph{Starttillstånd:} Projektledare A inloggad, inne på funktionalitetssidan för tidrapportering. A är projektledare i projektgrupp G. M är projektmedlem i projektgrupp G. En osignerad tidsrapport T1 i G för M finns för vecka 1 med 20 minuter under ``möte''. En osignerad tidsrapport T2 i G för M finns för vecka 2 med 30 minuter under ``möte''.
...
\item Det visas 50 minuter för ``möte'' för användare M.
\end{enumerate}
...
\item
\textbf{Administratör försöker ändra tidrapportmallens utformning efter att den har skapats}
