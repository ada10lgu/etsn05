...
\item Kontrollera att A är inloggad på dator B.
\item Kontrollera att A inte är inloggad på dator C.
\end{enumerate}
...
\emph{Starttillstånd:} Administratören A inloggad, sidan "Ta bort tidrapportmallar" visas, tidsrapportmall B används ej.

\emph{Sluttillstånd:} B finns ej i systemet.

\begin{enumerate}
\item A tar bort B.
\item Kontrollera att B är borttagen.
\end{enumerate}
\end{FT}
...
\begin{enumerate}
\item A kommer åt systemet. Skriver in URL till funktionalitet "Ändra lösenord".
...
\begin{enumerate}
\item A försöker navigera till administrationssida.
...
\begin{enumerate}
\item A väljer att tilldela roll.
\item A tilldelar roll ”t1 till projektmedlem B.
\item A sparar ändringar.
\item A har fått bekräftelse att B har fått roll som ”t1”.
\item Kontrollera att B har rollen "t1".
\end{enumerate}
...
\begin{enumerate}
\item A väljer att lista alla ej godkända tidrapporter
...
\begin{enumerate}
\item A väljer att lista alla godkända tidrapporter
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter
\item A väljer att sorterar i stigande ordning efter användare.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sortera i fallande ordning efter användare.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sorterar i stigande ordning efter vecka.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter
\item A väljer att sortera i fallande ordning efter vecka
\item Kontrollera att alla projektet tidrapporter är sorterade i fallande ordning efter vecka.
\end{enumerate}
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sortera i stigande ordning efter hurvida rapporten är godkänd eller ej
\item Kontrollera att alla projektet tidrapporter är sorterade i stigande ordning efter hurvida rapporten är godkänd eller ej
\end{enumerate}
...
\begin{enumerate}
\item A väljer att listar alla tidrapporter.
\item A väljer att sortera i fallande ordning efter hurvida rapporten är godkänd eller ej
\item Kontrollera att alla projektet tidrapporter är sorterade i fallande ordning efter hurvida rapporten är godkänd eller ej.
\end{enumerate}
...
\item A får bekräftelse att B har fått roll ”t1”.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sortera i stigande ordning efter användare.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sortera i stigande ordning efter vecka.
...
\begin{enumerate}
\item A väljer att lista alla tidrapporter.
\item A väljer att sortera i stigande ordning efter rapporten är godkänd eller ej.
...
\item A väljer ny projektledare.
...
\emph{Starttillstånd:} Administratör A är inloggat och projektgrupp D har projektledare B och C.

\emph{Sluttillstånd:} Administratör A har tagit bort  in projekledare B i projektgrupp D.

\begin{enumerate}
\item A öppna projektgrupp D.
\item A väljer ta bort projektledare.
...
\begin{enumerate}
\item A väljer att nå sidan för att lägga in B i projektgrupp D.
...
\begin{enumerate}
\item A väljer att nå sidan för att ta bort B i projektgrupp D.
...
\emph{Sluttillstånd:} Projektledare A fick bekräftelse att projektledare B kan inte tas bort i projektgrupp C.

\begin{enumerate}
\item A väljer att ta bort projektledar B i projektgrupp C.
\item A får bekräftelse att B kan inte tas bort i projektgrupp C.
\item Kontrollera att B är medlem i projektgrupp C.
\end{enumerate}
...
\begin{enumerate}
\item A väljer att ta bort projektgrupp.
...
\emph{Sluttillstånd:} Användare A kunde inte nå sidan att ta bort projektgrupp B.

\begin{enumerate}
\item A försöker nå sida att ta bort projektgrupp B.
\item A for bekräftelse att han/hon har inte rättigheter att ta bort projektgupp B.
\item Kontrollera att A kan inte nå sida.
\item Kontrollera att projektgrupp B är inte bortagen.
\end{enumerate}
...
\emph{Sluttillstånd:} Projektledare A kunde inte nå sidan att ta projektgrupp B.
...
\begin{enumerate}
\item A väljer att skapa ny användare.
\item A skapa användare B.
...
\begin{enumerate}
\item A väljer ny användarnamn.
\item A försöker skapa användarnamn B.
...
\begin{enumerate}
\item A väljer ny användarnamn.
\item A skriver användarenamn B som har mindre än 5 tecken.
\item A får bekräftelse att det är ogiltig användarnamn B.
\item A väljer ny användarnamn.
\item A skriver användarenamn C som har mer än 10 tecken.
\item A får bekräftelse att det är ogiltig användarnamn C.
\item A väljer ny användarnamn.
\item A skriver användarenamn D som innehåller ogilitg accii tecken.
...
\begin{enumerate}
\item A väljer ny användarnamn.
\item A skriver användarenamn B som har 5 tecken.
\item A får bekräftelse att användarnamn B är skapat.
\item A väljer ny användarnamn.
\item A skriver användarenamn C som har 10 tecken.
\item A får bekräftelse att användarnamn C är skapat.
\item A väljer ny användarnamn.
\item A skriver användarnamn D som innehålle gilitg accii tecken.
...
\item
\begin{enumerate}
\item Kontrollera att mallen är skapad och sparad.
\item A får ett felmeddelande ifall aktivitets och subaktivitetsnamnen inte är tillåtna, A omdirigeras då till steg 4.
\end{enumerate}
\item Kontrollera att mallen är ihopkopplad med grundmappen.
\item Kontrollera att A dirigeras till en sida med den färdiga mallen och en bekräftelse visas.
...
\item Kontrollera att om det inte finns några tidsrapportmallar ska det tydligt synas att det inte finns några.
\end{enumerate}
...
\item
\begin{enumerate}
\item Kontrollera att tidsrapportmallen är borttagen.
\item A får ett felmeddelande ifall tidsrapportmallen används av en projektgrupp och inte kan tas bort.
\end{enumerate}
\item Kontrollera att A får en uppdaterad lista över tidsrapportmallarna som finns i systemet.
\end{enumerate}
