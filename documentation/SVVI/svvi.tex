...
\item Se till att A dirigeras om till inloggningssidan.
\end{enumerate}
\end{FT}
...
\item Se till att B har roll ”t1”.
\end{enumerate}
...
\item Se till att alla ej godkända tidrapporter är listade.
\end{enumerate}
...
\item Se till att alla godkända tidrapporter är listade.
\end{enumerate}
...
\item Se till att alla projektets tidrapporter är sorterade i stigande ordning efter användare.
\end{enumerate}
...
\item A listar alla tidrapporter.
\item A sortera i fallande ordning efter användare.
\item Se till att alla projektets tidrapporter är sorterade i fallande ordning efter användare.
\end{enumerate}
...
\item Se till att alla projektets tidrapporter är sorterade i stigande ordning efter vecka.
\end{enumerate}
...
\item Se till att alla projektets tidrapporter är sorterade i fallande ordning efter vecka.
\end{enumerate}
...
\item Se till att alla projektets tidrapporter är sorterade i stigande ordning efter rapporten är godkänd eller ej.
\end{enumerate}
...
\item A listar alla tidrapporter.
\item A sortera i stigande ordning efter rapporten är godkänd eller ej.
\item Se till att alla projektets tidrapporter är sorterade i fallande ordning efter rapporten är godkänd eller ej.
\end{enumerate}
...
\item Se till att projektgrupp D är skapat.
\end{enumerate}
...
\item Se till att A kan inte nå administrationsvyn.
\item Se till att A har inte administration rättigheter.
\end{enumerate}
...
\item Se till att C är i projektgrupp D.
\end{enumerate}
...
\item Se till att B är bortaget.
\end{enumerate}
...
\item Se till att B är inte medlem i projektgrupp D.
\end{enumerate}
...
\item Se till att B är i projektgrupp D.
\end{enumerate}
...
\item Se till att B är medlem i projektgrupp D
\end{enumerate}
...
\item Se till att projektgrupp D är bortaget.
\end{enumerate}
...
\item Se till att A kan inte nå sida.
\item Se till att projektgrupp D är inte bortagen.
\end{enumerate}
...
\begin{enumerate}
\item Se till att A har tillgång till lista på administrationssida var alla användare är listade med både användarnamn och lösenord.
\end{enumerate}
...
\item Se till att B är inte bortagen.
\end{enumerate}
...
\item Se till att det finns användare B.
\end{enumerate}
...
\item Se till att det B kan logga in med tilldelat lösenord.
\end{enumerate}
...
\item Se till att det finns inte användarnamn B.
\end{enumerate}
...
\item Se till att det finns inte användarnamn B,C och D.
\end{enumerate}
...
\item Se till att det finns användarnamn B, C och D.
\end{enumerate}
...
\item A får bekräftelse att ogiltig tecken används.
\item Se till att det finns inte  projektgruppsnamn B,C och D.
...
\item Se till att det finns  projektgruppsnamn B,C och D.
\end{enumerate}
...
\item Se till att det finns inte två projektgruppsnam B.
\end{enumerate}
...
\item Se till att projektgrupp B,C,D,E och F är skapat.
\end{enumerate}
...
\item Se till att projektgrupp B,C,D,E,F är skapat och G finns inte.
\end{enumerate}
...
\item Se till att B finns i projektgrupp C,D,E,F och G.
...
\item Se till att projektgrupp B är inte skapat.
\end{enumerate}
...
\item A får bekräftelse att projektgrupp B är skapat.
\item Se till att projektgrupp B är skapat.
\end{enumerate}
...
\item Se till att alla 20 användare är inlagda i systemet.
\end{enumerate}
...
\item Se till att 21-sta användare är inte i systemet.
\end{enumerate}
...
\item Se till att B har roll ”t1” i projekt E.
\item Se till att C har roll ”t2” i projekt E.
\item Se till att D har roll ”t3” i projekt E.
\end{enumerate}
...
\item Se till att C har roll ”t2” i projekt E.
\item Se till att D har roll ”t3” i projekt E.
\item Se till att E har inte roll ”t4” i projekt E.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t1” i projekt K.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t2” i projekt K.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t3” i projekt K.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t1” i projekt K.
\item Se till att H har inte roll ”t1” i projekt K.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t2” i projekt K.
\item Se till att H har inte roll ”t2” i projekt K.
\end{enumerate}
...
\item Se till att B,C,D,E,F och G har roll ”t3” i projekt K.
\item Se till att H har inte roll ”t3” i projekt K.
\end{enumerate}
...
\item Se till att A kan logga in med användarnamn ”admin” och lösenord ”adminpw”.
\end{enumerate}
