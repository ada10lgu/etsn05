...
\item A trycker på ``Genererate statistics''.
\item Kontrollera att en ny tidrapport visas med M1s rapporter för vecka 1,2 och 4.
\end{enumerate}
...
\begin{enumerate}
\item A väljer t2 för vecka 1, 2 och 4.
\item A trycker på ``Genererate statistics''.
\item Kontrollera att en ny tidrapport visas med t2 rapporter för vecka 1,2 och 4.
\end{enumerate}
