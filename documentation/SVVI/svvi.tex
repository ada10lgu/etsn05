...
\fancyhead[R]{Datum: \today |Version: 1.4 | Dokumentnummer: PUSS144403}
...
1.4 & 4 november 2014 & TG & uppdaterad efter SVVS v1.3. FT 2.1.2 utgår. FT 3.2.9 och 3.2.11 har uppdaterats till "konsekutiva veckor".
...
\item Försök tilldela rollen ``Project Leader'' till M.
\item Kontrollera att ett felmeddelande visas som visar att det inte kan finnas fler projektledare.
\item Kontrollera i databasen att M inte har fått rollen ``Project Leader''.
\end{enumerate}
...
\emph{Sluttillstånd:} Projektmedlemmen M är inte inloggad i systemet. M och Projektledaren L är båda medlemmar i projektgruppen G. En osignerad tidsrapport T för projekt G, projektmedlem M och vecka 1 finns i systemet med 20 minuter på möte registrerat. M har lösenordet ``abcdef''.
...
\item Klicka på ``View'' under ``Time Reports''.
\item Markera tidrapport för vecka 1 och klicka på ``View''.
...
\item Skriv in det gamla lösenordet.
...
\emph{Starttillstånd:} Projektledare PL inloggad. En projektgrupp G finns. PL är projektledare i G. En användare U finns i systemet och är medlem i G. U har två tidrapporter för olika veckor.
...
PL väljer U
\item 
PL väljer 'alla veckor'
\item
Kontrollera att rapport med tiden från båda veckorna visas.
\end{enumerate}
...
\begin{enumerate}
\item
A navigerar till tidrapportering och sedan till visa statistik (se ref. 2, figur 7).
\item 
A väljer "Generera statistik" i menyn
\item
A väljer U
\item 
A väljer 'alla veckor'
\item
Kontrollera att rapport med tiden från båda veckorna visas.
\end{enumerate}
